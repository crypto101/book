...
\DeclareDocumentCommand{\illustration}{
  ...
  \begin{figure}[ht!]
    \centering
    \includegraphics[width=#1\linewidth]{./Illustrations/#3.pdf}
...
\renewcommand{\maketitle}{%
  ...
  International (CC BY 4.0) license. You can find the full text of the
  license at \url{https://creativecommons.org/licenses/by/4.0/}.

  \begin{center}
    \includegraphics{./CC-BY.pdf}
  \end{center}
  ...
  \begin{itemize}
  \item Attribution: you must give appropriate credit, provide a
