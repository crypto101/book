...
MD5 is a hash function designed by Ronald Rivest in 1991 as an extension of MD4. This hash function outputs 128-bit digests. In 2004 research conducted by Xiaoyun Wang, Dengguo Feng, Xuejia Lai and Hongbo Yu showed that MD5 is vulnerable to collision attacks, therefore it is recommended not to use this hash function when storing sensitive information such as passwords.
