...
#+BEGIN_LATEX
\illustration{BlockCipher/AllNodes}[.85][All of the 16 nodes operated on by the block cipher. Each of the nodes is designated by a hexadecimal digit.][fig:BlockCipherBlocks]
#+END_LATEX
