...
Choosing $p$ and $q$ in some funny way such that $|p-q|$ is small, the entire implementation is vulnerable to Fermat factorization. Using this method, $n$ can be factorized easily. The actual method is highly mathematical and might be out of the scope of this book.
