...
flipped. This makes the cipher resistant to linear attacks, unlike the earlier
DES algorithm, whose fifth S-box caused serious security problems. [fn:: In its
defense, linear attacks were not publicly known back when DES was designed.]
