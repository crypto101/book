...
\Gls{AEAD} is a feature of certain kinds of authenticated encryption.
It starts with the premise that many messages actually consist of two
parts:
...
OCB mode is an \gls{AEAD} mode of operation.
