...
a block size.
%**HMM** What does th last sentence mean? I have a vague idea that one can handle more than one block at the same time (because of the "straight flipping dependency"), but this sentence does not really explain it and leaves me confused.
