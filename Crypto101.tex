...
%**HMM** A nice example where your mind raced ahead of what you wrote (happens to you sometimes - I'll point out all such issues :-) ): "We could use PKE for everything. By far the most important reason for this is performance." This sounds as if /because of performance, we should use PKE everything." Of course, it's the other way round. Therefore, the following paragraph should start with:
But this does not work in practice.
%**HMM** And now the "this" refers to "it does not work", instead of "we should use PKE".
...
means approximately 20 kilocycles, which is about 500 times faster. The state of the art in secure
symmetric ciphers is even better: \hyperref[AES]{AES}-GCM with hardware acceleration
